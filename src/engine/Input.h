...
class Input {
 ...
 public:
	...
	enum Key {
		Return = SDL_SCANCODE_RETURN | SDLK_SCANCODE_MASK,
		Escape = SDL_SCANCODE_ESCAPE | SDLK_SCANCODE_MASK,
		Backspace = SDL_SCANCODE_BACKSPACE | SDLK_SCANCODE_MASK,
		Tab = SDL_SCANCODE_TAB | SDLK_SCANCODE_MASK,
		Space = SDL_SCANCODE_SPACE | SDLK_SCANCODE_MASK,
		NumRow0 = SDL_SCANCODE_0 | SDLK_SCANCODE_MASK,
		NumRow1 = SDL_SCANCODE_1 | SDLK_SCANCODE_MASK,
		NumRow2 = SDL_SCANCODE_2 | SDLK_SCANCODE_MASK,
		NumRow3 = SDL_SCANCODE_3 | SDLK_SCANCODE_MASK,
		NumRow4 = SDL_SCANCODE_4 | SDLK_SCANCODE_MASK,
		NumRow5 = SDL_SCANCODE_5 | SDLK_SCANCODE_MASK,
		NumRow6 = SDL_SCANCODE_6 | SDLK_SCANCODE_MASK,
		NumRow7 = SDL_SCANCODE_7 | SDLK_SCANCODE_MASK,
		NumRow8 = SDL_SCANCODE_8 | SDLK_SCANCODE_MASK,
		NumRow9 = SDL_SCANCODE_9 | SDLK_SCANCODE_MASK,
